...
from LSTMtrainer import BaseLSTMCRFTrainer
...
# label_path='./data0520/y_train_bio.txt'
# input_test_path='./data0520/x_test.txt'
# label_test_path='./data0520/y_test_bio.txt'
...
if __name__ == "__main__":
	...
	#model=torch.load('./pkl/long_model_lstm_bio2.pkl')
	...
	torch.save(model,'./pkl/0530_multi_model_lstm.pkl')
