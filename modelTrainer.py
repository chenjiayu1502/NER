...
class BaseLSTMCRFTrainer(object):
    def __init__(self, model: M.LSTMCRF, epochs,input_vocabs,label_vocab, optimizer=O.RMSprop):
        ...
        self.optimizer = optimizer(self.model.parameters(),lr=0.0002)
        self.gpu_main = None
    ...
    def write_result2(self,sen,pred,targ):
        print('writing_result...........')
        f=open('./result/0622_long_pred_lstmcrf.txt','w')
    ...
    def train(self,data, data_size):
        ...
        for e_idx in range(self.epochs):
            ...
            torch.save(self.model,'./pkl/0622_multi_long_model_lstmcrf'+str(e_idx+30)+'.pkl')
